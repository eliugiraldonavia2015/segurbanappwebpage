...
const CLIENTS = [
  { name: "Surubi’i", country: "Paraguay" },
  { name: "Las Casuarinas", country: "Perú" },
  { name: "Hacienda San Simón", country: "Colombia" },
  { name: "Altos de la Tahona", country: "Uruguay" },
  { name: "Piedra Roja", country: "Chile" },
  { name: "Santa Cruz La Vieja", country: "Bolivia" },
  { name: "ACEIS S.A.S.", country: "Colombia" },
  { name: "La Planicie", country: "Perú" },
  { name: "Rakiura", country: "Paraguay" },
  { name: "Lomas de La Tahona", country: "Uruguay" },
  { name: "Las Brisas de Chicureo", country: "Chile" },
  { name: "Ciudad El Triunfo", country: "Bolivia" },
  { name: "Condominio El Peñón", country: "Colombia" },
  { name: "El Haras", country: "Perú" },
  { name: "Santa María de la Lomada", country: "Paraguay" },
  { name: "Lagos de Carrasco", country: "Uruguay" },
  { name: "Hacienda de Chicureo", country: "Chile" },
  { name: "Condominio Montibello", country: "Bolivia" },
  { name: "Abelardo Yepes S.A.S.", country: "Colombia" },
  { name: "Sol de La Molina", country: "Perú" },
  { name: "San Bernardino Country", country: "Paraguay" },
  { name: "Carmel", country: "Uruguay" },
  { name: "Valle Escondido", country: "Chile" },
  { name: "Buen Vivir Urbanizaciones", country: "Bolivia" },
  { name: "Ruitoque Golf Country", country: "Colombia" },
  { name: "Los Cóndores", country: "Perú" },
  { name: "Grupo Vierci", country: "Paraguay" },
  { name: "Pueblo Mío", country: "Uruguay" },
  { name: "Condominio El Huinganal", country: "Chile" },
  { name: "Jardín Real", country: "Bolivia" },
  { name: "Mesa de Yeguas", country: "Colombia" },
  { name: "Asia Golf Club", country: "Perú" },
  { name: "Condominio Aqua Village", country: "Paraguay" },
  { name: "Viñedos de la Tahona", country: "Uruguay" },
  { name: "Santuario del Valle", country: "Chile" },
  { name: "Colinas del Urubó", country: "Bolivia" },
  { name: "Club La Pradera", country: "Colombia" },
  { name: "Cerros de Camacho", country: "Perú" },
  { name: "Blue Lagoon", country: "Paraguay" },
  { name: "San Nicolás", country: "Uruguay" },
  { name: "San Carlos de Apoquindo", country: "Chile" },
  { name: "Lomas del Sol", country: "Bolivia" },
  { name: "Edificio Vitrum", country: "Colombia" },
  { name: "Encantada de Villa", country: "Perú" },
  { name: "Costa del Lago", country: "Paraguay" },
  { name: "Jardines de Carrasco", country: "Uruguay" },
  { name: "Marbella Resort", country: "Chile" },
  { name: "Sevilla Los Jardines", country: "Bolivia" },
  { name: "Urbanización Terranova", country: "Colombia" },
  { name: "Lagunas de La Molina", country: "Perú" },
  { name: "Paraná Country Club", country: "Paraguay" },
  { name: "Huertas de los Horneros", country: "Uruguay" },
  { name: "Las Tacas", country: "Chile" },
  { name: "Condominio La Hacienda", country: "Bolivia" },
  { name: "Cusezar", country: "Colombia" },
  { name: "Viva GyM", country: "Perú" },
  { name: "Yacht y Golf Club", country: "Paraguay" },
  { name: "Cumbres de Carrasco", country: "Uruguay" },
  { name: "Inmobiliaria Socovesa", country: "Chile" },
  { name: "Vista Verde", country: "Bolivia" },
  { name: "Amarilo", country: "Colombia" },
  { name: "Monterrico", country: "Perú" },
  { name: "Sunset Hills", country: "Paraguay" },
  { name: "Olivos de los Horneros", country: "Uruguay" },
  { name: "ComunidadFeliz", country: "Chile" },
  { name: "Barrio Aranjuez", country: "Bolivia" },
  { name: "Condominio Campestre", country: "Colombia" },
  { name: "Rinconada del Lago", country: "Perú" },
  { name: "Condominio Moravia", country: "Paraguay" },
  { name: "Laguna Blanca", country: "Uruguay" },
  { name: "Chicureo", country: "Chile" },
  { name: "Condominio Los Pinos", country: "Bolivia" },
  { name: "Ciudad Jardín", country: "Colombia" },
  { name: "Constructora Líder", country: "Perú" },
  { name: "Pilar del Norte", country: "Paraguay" },
  { name: "La Asunción", country: "Uruguay" },
  { name: "Santa María de Manquehue", country: "Chile" },
  { name: "Condominio El Bosque", country: "Bolivia" },
  { name: "Constructora Meléndez", country: "Colombia" },
  { name: "San Isidro Golf", country: "Perú" },
  { name: "Inmobiliaria Raíces", country: "Paraguay" },
  { name: "Barrio Privado Carlotta", country: "Uruguay" },
  { name: "Inmobiliaria Almagro", country: "Chile" },
  { name: "Condominio El Paso", country: "Bolivia" },
  { name: "Neivor", country: "Colombia" },
  { name: "Chacarilla", country: "Perú" },
  { name: "La Trinidad", country: "Paraguay" },
  { name: "Pilar de los Horneros", country: "Uruguay" },
  { name: "Lo Barnechea", country: "Chile" },
  { name: "Las Palmas", country: "Bolivia" }
];
